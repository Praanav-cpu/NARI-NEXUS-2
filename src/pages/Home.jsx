  ...
  const teamMembers = [
    {
      ...
      linkedin: 'https://www.linkedin.com/in/kritika-rukhiyana-65a28a307?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app',
    ...
    },
    {
      ...
      socials: {
        instagram: 'https://www.instagram.com/sunidhi_vj?igsh=MWs1NHY1N3F6bXRibg==',
        linkedin: 'https://www.linkedin.com/in/sunidhi-haware-797a97323?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app',
        // github: 'https://github.com/kritika',
    ...
    },
    {
      ...
      socials: {
        instagram: 'https://www.instagram.com/pradhyumnya_patil?igsh=bDZycHdvaDA3cW5y',
        linkedin: 'https://www.linkedin.com/in/pradhunya-gawande?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app',
    ...
    },
    {
      ...
      image: '/img/Rishu.jpg',
      socials: {
        instagram: 'https://www.instagram.com/rishukr.singh?igsh=Z3R1YTdrMmpkY2Vn',
        linkedin: 'https://www.linkedin.com/in/rishukrsingh?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app',
        // github: 'https://github.com/kritika',
    ...
    },
    {
      ...
      socials: {
        instagram: 'https://www.instagram.com/prana_v.18_?igsh=MTlxeG82b3d3Y2p1dw==',
        linkedin: 'https://www.linkedin.com/in/pranav-tekade-57b5a2320?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app',
    ...
    },
    {
      ...
      image: '/img/Bawli.jpg',
      socials: {
        instagram: 'https://www.instagram.com/ayushthakre__?igsh=cGduOGl2eW1va21x',
        linkedin: 'https://www.linkedin.com/in/ayush-thakre-096558294?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app',
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              NariNexus is a vibrant community initiative dedicated to empowering women in technology and related fields. 
              We provide a dynamic platform for women to connect, learn, and lead through a variety of events, including 
              hackathons, webinars, seminars, and mentorship programs across India. Our mission is to bridge the gender gap
               in traditionally male-dominated industries by fostering an inclusive environment where women can thrive.
              </p>

              <p className="text-gray-300 mb-6">
              Women remain underrepresented in key sectors like tech, gaming, and sports. They hold only 26.7% of tech jobs globally, just 5% of professional esports roles, 
              and 13% of top positions in cricket. Despite progress, leadership opportunities for women are still limited. 
              NariNexus is working to close this gap by creating inclusive spaces for mentorship, learning, and growth.
              </p>

              <p className="text-gray-300">
              NariNexus is for aspiring and established women in tech, gaming, and sports who seek growth and visibility. It also welcomes students, professionals, 
              and allies committed to gender diversity. Whether you're looking to upskill, connect, or create impact. NariNexus is your platform to thrive in fields
